...
/// </summary>
internal class DynamicSprinkleState : ABaseState
{
    ...
    internal TimeSpan MaxOffset;

    // Chosen distribution for adding this sprinkle
    internal ETimeFrameDistribution TimeDistribution;

    internal DynamicSprinkleState(string activityType, string resource, HashSet<ProcessState> beginAfter,
